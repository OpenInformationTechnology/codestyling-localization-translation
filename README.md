...
* Feature: added WP language files list (admin, admin-network, continents-cities)
* Feature: added Yandex Translate API (http://api.yandex.ru/translate/)
* Feature: added Apertium Translate API for Esperanto
* Feature: added Bengali Language support
* Bugfix: restore Free Web-based Google Translate API
* Bugfix: mo file name generation
